...
#wire inching speed
speed=eval(input("Enter the wire-inching speed"))
...
for i in range(speed):
    ...
    time.sleep(1)
# wire inching length
length=eval(input("enter the  wire inching Length"))
for j in range(length):
    driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/header[1]/div[1]").click()
    driver.find_element(By.XPATH,"//div[@class='slider-bottom__button slider-bottom__button--inc']").click()
    driver.find_element(By.XPATH,"//div [contains(text(),'Done')]").click()
    time.sleep(1)
